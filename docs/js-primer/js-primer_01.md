...
本书的文本和源代码作为开源项目在 GitHub 的[asciidwango/js-primer](https://github.com/asciidwango/js-primer)上公开。 此外，由于书籍内容在[jsprimer.net](https://jsprimer.net/)上公开，因此可以在 Web 浏览器中阅读。 在 Web 版本中，您可以即时运行示例代码并学习 JavaScript。
...
您可以提问或发送 Pull Request 直接支持书籍。有关 Issue 和 Pull Request，请参阅下一页。
