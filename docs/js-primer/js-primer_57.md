...
| `123_456` | [ES2021] 数值文字中的**数字分隔符** | 数据类型和文字 | [词法语法](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Lexical_grammar#%E6%95%B0%E5%80%A4%E3%83%AA%E3%83%86%E3%83%A9%E3%83%AB) |
...
| `===` | 严格等于操作符 | 演算子 | [严格相等 (===)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Strict_equality) |
| `!==` | 严格不等于操作符 | 演算子 | [严格不等于 (!==)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Strict_inequality) |
...
| `>=` | 大于等于操作符/以上 | 演算子 | [大于等于 (>=)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Greater_than_or_equal) |
| `<` | 小于操作符/更小 | 演算子 | [小于 (<)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Less_than) |
| `<=` | 小于等于操作符/以下 | 演算子 | [小于等于 (<=)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Less_than_or_equal) |
| `&` | 位逻辑与 | 演算子 | [位逻辑与 (&)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Bitwise_AND) |
| ` | ` | 位逻辑或 | 演算子 | [位逻辑或 ( | )](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Bitwise_OR) |
| `^` | 位逻辑异或 | 演算子 | [位逻辑异或 (^)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Bitwise_XOR) |
| `~` | 位逻辑非 | 演算子 | [位逻辑非 (~)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Bitwise_NOT) |
| `<<` | 左移操作符 | 演算子 | [左移 (<<)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Left_shift) |
| `>>` | 右移操作符 | 演算子 | [右移 (>>)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Right_shift) |
| `>>>` | 零填充右移操作符 | 演算子 | [无符号右移 (>>>)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Unsigned_right_shift) |
| `&&` | AND 演算子 | 演算子 | [逻辑与 (&&)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Logical_AND) |
| `??` | [ES2020] Null 合并操作符 | 演算子 | [Null 合并 (??)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Nullish_coalescing) |
| `&#124;&#124;` | OR 演算子 | 运算符 | [逻辑或 (&#124;&#124;)](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Logical_OR) |
...
| サンプル | 说明 | 解说 | MDN |
| --- | --- | --- | --- |
| `function f(){}` | **函数**声明 | 函数与声明 | [函数声明](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Statements/function) |
| `const f = function(){};` | **函数**式 | 函数与声明 | [函数式](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/function) |
| `const f = () => {};` | [ES2015] **箭头函数**的声明 | 函数与声明 | [箭头函数式](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Functions/Arrow_functions) |
...
| 代码 | 描述 | 解释 | MDN |
| --- | --- | --- | --- |
| `import x from "./x.js"` | [ES2015] **默认导入** | ECMAScriptモジュール | [Import](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Statements/import) |
...
| `import { x as y } from "./x.js"` | [ES2015] 名前付きインポートの**别名** | ECMAScript 模块 | [Import](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Statements/import) |
